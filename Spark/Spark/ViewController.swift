    ...
    override func viewDidLoad() {
        ...
        for i in 0...3
        {
            ...
            ref.getData(completion:  { error, snapshot in
                ...
                locations.append(CLLocation(latitude: self.latData1, longitude: self.longData1))
                print(locations)
        ...
        /* for a[i] in 0...1000
        {
         locations.append(CLLocation((latitude: a["locData"] as? [String:Any])?["lat"] as? Double ?? -1, longitude: a["locData"] as? [String:Any])?["long"] as? Double ?? -1))
